document.addEventListener("DOMContentLoaded", function (event) {
    ...
    class SingleDetailedResult {
        constructor(id, mealName, alcohol, category, glass, image, instructions, youtubeLink, ingredients, measures) {
            this.id = id;
    ...
    /**
     * after search button was clicked, send GET request with AJAX -> API responds with the shortCocktail
    ...
    function triggerShortMealSearch (searchOption, searchInput) {
        ...
        const ourAPIUrl = "http://localhost:8080/api/recipionist/cocktail/";
        ...
        xmlhttp.onreadystatechange = function () {
            ...
            if (this.readyState == 4 && this.status == 200) {
                ...
                */
                    ...
                    let alcohol = responseObj.alcohol;
                    let glass = responseObj.glass;
                ...
                //remove the previous search results from the page
                    ...
                    let singleDetailedResult = new SingleDetailedResult(id, name, alcohol, category, glass, image, instructions, youtubeLink, ingredients, measures);
    ...
    /**
     * show the possible search values if choose glass or category
     * @type {Element}
     */
    ...
    function showAvailableSelectValues(e) {
        ...
        if (selectItem.value === "category/" || selectItem.value === "glass/") {
            //show the
            ...
            ajaxRequest.onreadystatechange = function () {
                ...
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    if (selectedValue === "category") {
                        ...
                        responseList.forEach(item => {
                            if (item.glass === "Unknown"){
                                //do nothing
                            } else {
                                let option = document.createElement("option");
                                let textOption = document.createTextNode((item.glass));
                                option.appendChild(textOption);
                                option.value = item.glass;
                                option.id = "area-" + item.glass;
                                listOfOptions.push(option);
                            }
                        });
                    }
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //Categories
    //class to display results on the screen
